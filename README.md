...
1. Open the [SAP Web IDE Full-Stack](https://webidecp-<youraccountname>trial.dispatcher.hanatrial.ondemand.com/). If the above URL didn't work, you have to activate the Web IDE full stack service:
  ...
  1.1 Go to [SAP Cloud Cockpit](https://account.hanatrial.ondemand.com/cockpit#/home/overview).

  1.2 At the bottom of the page, select the button with the text "trail"

  1.3 click on your account number

  1.4 Under the services at the left side, search for Web IDE Full-Stack and enable it.
